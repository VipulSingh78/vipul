...
st.subheader('Upload an image of a product or capture with your camera, and get recommendations!')
...
# File uploader for gallery images
...
st.markdown("### Or capture an image using your Camera:")
